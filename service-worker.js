"use strict";
var precacheConfig = [["/Personal-web-site/index.html", "09dd6f61d164333ce9697fbc948f79df"], ["/Personal-web-site/static/css/main.01d88c05.css", "0e895e5761383151678dee12e855313b"], ["/Personal-web-site/static/js/0.40d955c5.chunk.js", "e756bf8bf986d2daec47738b8173e8ce"], ["/Personal-web-site/static/js/1.58171f36.chunk.js", "1af4deeb4892daafa4338550d04ce17c"], ["/Personal-web-site/static/js/2.9f82d27a.chunk.js", "6eab49a8219e08f82267567eb239b076"], ["/Personal-web-site/static/js/3.1b8722d3.chunk.js", "d71baa25d5221f19a8bf8862a75f34e9"], ["/Personal-web-site/static/js/main.4b859b6a.js", "e66a484feea593697938292d41682d7c"]],
  ...
  var s = new URL(e);return r && s.pathname.match(r) || (s.search += (s.search ? "&" : "") + encodeURIComponent(t) + "=" + encodeURIComponent(n)), s.toString();
},
  ...
  var t = e[0],
      ...
      s = createCacheKey(r, hashParamName, n, /\.\w{8}\./);return [r.toString(), s];
  ...
  if ("GET" === e.request.method) {
    var t,
        ...
        r = "index.html";(t = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, r), t = urlsToCacheKeys.has(n));var s = "/Personal-web-site/index.html";!t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL(s, self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
